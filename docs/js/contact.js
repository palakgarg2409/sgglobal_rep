var confirm = document.getElementsByClassName("contactConfirmation");
...
document.getElementById('contactForm').addEventListener('submit', function(event) {
  ...
  console.log("1: Inside the event Listener");
...
//   const formData = new FormData(this);
  ...
  fetch('https://us-central1-sgglobalrep.cloudfunctions.net/sendEmail', {
    method: 'POST',
    headers: {
